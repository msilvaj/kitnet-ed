...
class WhatsappsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create whatsapp" do
    assert_difference('Whatsapp.count') do
      post whatsapps_url, params: { whatsapp: { endereco: @whatsapp.endereco, inquilino_id: @whatsapp.inquilino_id, numero: @whatsapp.numero } }
    end
  ...
  test "should update whatsapp" do
    patch whatsapp_url(@whatsapp), params: { whatsapp: { endereco: @whatsapp.endereco, inquilino_id: @whatsapp.inquilino_id, numero: @whatsapp.numero } }
