...
class PagamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pagamento" do
    assert_difference('Pagamento.count') do
      post pagamentos_url, params: { pagamento: { inquilino_id: @pagamento.inquilino_id, mes: @pagamento.mes, pago: @pagamento.pago } }
    end
  ...
  test "should update pagamento" do
    patch pagamento_url(@pagamento), params: { pagamento: { inquilino_id: @pagamento.inquilino_id, mes: @pagamento.mes, pago: @pagamento.pago } }
